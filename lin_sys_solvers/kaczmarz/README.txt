Kaczmarz Algorithm: Approximately solve a user specified linear system of equations, Ax = b, (of order N) to a specified degree of accuracy through an iterative procedure.
...
kaczmarz.cpp input(s):
	...
	- desired accuracy for approximate solution (hard-coded), eps.
	- maximum number of iterations (hard-coded), max_iter.
